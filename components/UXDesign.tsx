          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[50%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow pr-28 pl-px text-xl text-black max-md:mt-10 max-md:max-w-full">
                <a href="https://www.figma.com/design/KnpMkNrvYc3zvv0JbfPexw/Seekway?node-id=0%3A1&t=BrT1buVKUfXf4OuY-1">
                  <img
                    loading="lazy"
                    src="/Rectangle 38.png" // Adjusted to correct path starting from the root
                    className="w-full aspect-[1.4] max-w-[470px] max-md:max-w-full shadow-xl hover-image rounded-xl"
                  />
                </a>
                ...
                <a href="https://www.figma.com/design/uqtPHYoeajPcr77twzClUF/portfolio?node-id=0%3A1&t=KTJAxsktgDhCM38G-1">
                  <img
                    loading="lazy"
                    src="/Rectangle 38 (2).png"
                    className="mt-32 w-full aspect-[1.51] max-w-[470px] max-md:mt-10 max-md:max-w-full shadow-xl hover-image rounded-xl"
                  />
                </a>
            ...
            <div className="flex flex-col w-[50%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow pr-28 pl-px text-xl text-black max-md:mt-10 max-md:max-w-full">
                <a href="https://www.figma.com/design/lhd2Zdh7r5ZF2V100JzY3F/E-Foodie-Web?t=BrT1buVKUfXf4OuY-1">
                  <img
                    loading="lazy"
                ...
                <a href="https://www.figma.com/design/LGy9BME6TtBe9jOrbqvMOO/Go2pos-Marketing?node-id=0%3A1&t=BrT1buVKUfXf4OuY-1">
                  <img
                    loading="lazy"
